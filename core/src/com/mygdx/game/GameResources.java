...
public class GameResources {
    ...
    public static final String LIFE_IMG_PATH = "textures/life.png";
    public static final String PLAY_BUTTON_IMG_PATH = "textures/pause_icon.png";
    public static final String SHORT_BUTTON_IMG_PATH = "textures/button_background_short.png";
    public static final String LONG_BUTTON_IMG_PATH = "textures/button_background_long.png";
